...
/** 활동 참여 신청/취소 (U-04, U-05) */
@Tag(name = "활동 참여 (C)", description = "로그인 회원의 활동 참여 신청·취소 (U-04, U-05). 역할 무관.")
@RestController
...
public class ParticipationController {
    ...
    @Operation(summary = "U-04 참여 신청", description = "로그인한 회원이 활동에 참여 신청한다. 닉네임은 계정에서 서버가 채운다.")
    @PostMapping
    ...
    @Operation(summary = "U-05 참여 취소", description = "로그인한 회원이 자신의 참여 신청을 취소한다.")
    @DeleteMapping
